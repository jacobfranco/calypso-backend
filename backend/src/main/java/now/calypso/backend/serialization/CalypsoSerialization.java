...
public class CalypsoSerialization extends ThriftSerialization {
    ...
    protected Map<Integer, Class> typeIds() {
        ...
        Class[] classes = {
                ...
                PublicPromptAnswer.class,
                PublicPromptFeedCard.class,
                PublicPromptReactionEvent.class,
                PublicPromptSelection.class,
                PrivatePromptAssignment.class,
                PrivatePromptAnswer.class,
                PrivatePromptStatus.class,
                ActivePrivatePrompt.class,
                AgentMessage.class,
                AgentSession.class,
                TagPreference.class,
                DirectMessage.class,
